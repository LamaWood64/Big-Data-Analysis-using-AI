...
print("  📊 02_monthly_sales_trend.png")
print("  📊 03_sales_by_region.png")
print("  📊 04_top10_states_sales.png")
print("  📊 05_sales_profit_by_shipmode.png")
print("  📊 06_sales_profit_scatter.png")
print("  📊 07_elbow_method.png")
print("  📊 08_customer_clusters.png")
print("  📊 09_clusters_comparison.png")
print("  📄 customer_clusters_results.csv")
print("  📄 cluster_summary.csv")
print("  📄 correlation_by_segment_category.csv")